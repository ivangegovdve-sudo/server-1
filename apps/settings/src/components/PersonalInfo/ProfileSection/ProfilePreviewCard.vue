...
.preview-card {
	...
	&__avatar {
		// the avatar straddles the boundary: ~80% in the banner, ~20% in the body
		position: absolute !important;
		top: 23px;
		inset-inline-start: 20px;
		border-radius: 50%;
		// visible white halo so the tinted banner does not touch the avatar
